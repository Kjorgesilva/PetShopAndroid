...
public class AgendamentoDAO {
    ...
    public long inserir(Agenda cadastro) {
        ...
        contentValues.put("status_agendamento", "P");
    ...
    public List<Agenda> ListarBanco(int idCliente) {
        ...
        Cursor cursor = getDabase().rawQuery("SELECT con._id_agenda, con.id_animal_agenda, con.id_cliente_agenda, con.dataInicio_agenda,con.id_endereco_agenda , con.dataFim_agenda, con.id_medico_agenda ,con.status_agendamento ," +
                ...
                " INNER JOIN medico med ON con.id_medico_agenda = med._id_medico  WHERE id_cliente_agenda = ? AND con.status_agendamento = 'P' " +
        ...
        while (cursor.moveToNext()) {
            ...
            listarCadastro.setStatus_agendamento(cursor.getString(cursor.getColumnIndex("status_agendamento")));
    ...
    public long update(Agenda agendamento) {
        ...
        values.put("_id_agenda", agendamento.getId());
        values.put("status_agendamento", agendamento.getStatus_agendamento());
        Log.e("pass", "update: " + agendamento.getStatus_agendamento());

        return getDabase().update("agenda", values, "_id_agenda = ?", new String[]{String.valueOf(agendamento.getId())});
    ...
    public List<Agenda> ListarBancoHistorico(int idCliente) {
        List<Agenda> listarTodosOsElementos = new ArrayList<Agenda>();
        // fazer um inner join
        String[] args = {String.valueOf(idCliente)};
        Cursor cursor = getDabase().rawQuery("SELECT con._id_agenda, con.id_animal_agenda, con.id_cliente_agenda, con.dataInicio_agenda,con.id_endereco_agenda , con.dataFim_agenda, con.id_medico_agenda ,con.status_agendamento ," +
